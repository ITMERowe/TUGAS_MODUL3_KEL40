    ...
    render() {
        return (
            <div>
                ...
                <button onClick={this.ubahkomponen1}>{this.state.komponen1 ? 'HIDE' : 'SHOW'} Names</button>
                <br/>
                <br/>
                <br/>
                {this.state.komponen2 ? <Child2 /> : ''}
                <button onClick={this.ubahkomponen2}>{this.state.komponen2 ? 'HIDE' : 'SHOW'} Counter</button>
            </div>
        );
    }
}
